...
echo "Please enter a The IP address"
read IP
...
xterm -fa 'Monospace' -fs 10 -hold -geometry 80x27+200+200 -bg black -fg white -e 'echo -ne "\033]0;nmap_allports\007";nmap -p- -oN nmap/initial_allports -vv $IP; echo "The Scan is saved in nmap/initial";read' &
...
# 	echo "hacked"
# fi
echo "Enter any port for FFuf Or nikto scan[default is port 80]"
read port
#Nikto
...
#Gobuster
xterm -fa 'Monospace' -fs 10 -hold -geometry 80x27+1930+626 -bg purple4 -fg white -e 'echo -ne "\033]0;gobuster\007";mkdir gobuster;ffuf -u http://$IP:$port/FUZZ -w /home/nvr/dirbuster/directory-list-lowercase-2.3-medium.txt -fc 404 -c -o directory.txt
;echo "The scan is save in gobuster/gobuster.txt"; read' &
